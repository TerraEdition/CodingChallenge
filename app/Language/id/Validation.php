...
return [
    ...
    'is_unique'             => 'Bidang {field} sudah pernah terdaftar sebelumnya.',
    ...
    'required_with'         => 'Bidang {field} diperlukan saat {param} diisi.',
    'required_without'      => 'Bidang {field} diperlukan saat {param} tidak diisi.',
    ...
    'valid_password'            => 'Bidang {field} harus berisi angka, huruf kecil, huruf besar, simbol dan minimal 5 karakter.',
    'valid_phone'       => 'Bidang {field} tidak valid, harus berisi 0 di awal, jumlah karakter 11-14.',
    'date_greater_than'       => 'Bidang {field} harus berisi tanggal yang lebih besar dari {param}.',
    'date_less_than'       => 'Bidang {field} harus berisi tanggal yang lebih kecil dari {param}.',
